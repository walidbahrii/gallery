<template>
  <div>
    ...
    <!--  <figure class="image is-4by3">
        <img src="https://i.pinimg.com/originals/53/71/d4/5371d40feb2a740d4c6f000b83ca2704.jpg" alt="Placeholder image">
      </figure>-->
    </div>
      ...
      <div class="card-footer btn-actions">
        <div class="card-footer-item field is-grouped">
          <div class="buttons">
            ...
            <button class="button is-success" v-if="product.isAddedToCart" @click="removeFromCart(product.id, false)">{{ removeFromCartLabel }}</button>
          </div>
